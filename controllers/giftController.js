...
exports.gift_request = async (req, res) => {
    ...
    try {
        ...
        const gift = await Gift.findById(giftId)
            .populate('family', "_id membersAlias")
        ...
        if (gift.family.membersAlias[0] !== undefined) {
            ...
            const makeRequest = await Gift.findByIdAndUpdate(req.body.giftId, {
            ...
            await Family.findByIdAndUpdate(gift.family._id, {
                $push: { membersAlias: alias }
            }, {
                new: true
            })

            res.status(200).json(makeRequest)
...
exports.accept_gift_request = async (req, res) => {
    ...
    try {
        ...
        // }
            ...
            const acceptRequest = await Gift.findByIdAndUpdate(giftId, {
            ...
            res.status(200).json({data:acceptRequest, message:"request accepted succesfully"})
